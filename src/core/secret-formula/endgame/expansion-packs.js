export const expansionPacks = {
  ...
  effarigPack: {
    ...
    get description() {
      ...
      基于最快终局用时的十分之一自动完成鹿颈长的每一层现实。（当前每层用时：${TimeSpan.fromMilliseconds(new Decimal(player.records.bestEndgame.realTime).times(10)).toStringShort()}）`
    },
  ...
  laitelaPack: {
    ...
    get description() {
      return ` 解锁自动调整凝聚奇点用时；
      莱特拉的现实中游戏时间恢复速度翻倍；
      湮灭乘数对第八暗物质维度的效果 ^ 2（若湮灭乘数影响第八暗物质维度）；
